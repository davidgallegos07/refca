        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                `<tr>
                    ...
                    datax +='</td>';
                    datax += '<td> <a href="'+ value.BookPath +'">Descargar</a></td>';
                    datax += '<td>';
                    ...
                    datax += '</td>';
                    datax += `<td>
                        <a href="/Book/Edit/${value.id}" class="btn btn-sm btn-info"
                        data-toggle="tooltip" title="Editar"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                        <form action="/Book/Delete/${value.id}" method="post" class="js-delete inline">
