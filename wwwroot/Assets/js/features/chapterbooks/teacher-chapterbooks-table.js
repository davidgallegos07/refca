$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data.items, function (key, value) {
                    ...
                    <td class="path" hidden>${value.chapterbookPath}</td>  
                    <td>`;
    ...
    $(tbody).on('click', 'tr', function () {
        ...
        $.ajax({
            url: `/api/teacher/chapterbooks/${id}/role`,
            success: function (role) {
                ...
                console.log(path);
                data = `
                <li class="${authorized}"><a href="/Chapterbook/Edit/${id}">Editar</a></li>
                <li class="${authorized}"><a href="/Chapterbook/Upload/${id}">Añadir PDF</a></li>
                <li class="${existPath}"><a target="_blank" href="${path}">Descargar</a></li>
                    <li class="${authorized}">
                        <form action="/Chapterbook/Delete/${id}" method="post" class="js-delete">
