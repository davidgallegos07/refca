        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                `<tr>
                    ...
                    <td>`;
                    $.each(value.teacherChapterbooks, function(key, value){
                        datax +='<p>' + value.name + '</p>';
                    });
                    datax +='</td>';
                    datax += '<td> <a href="'+ value.chapterbookPath +'">Descargar</a></td>';
                    datax += '<td>';
                    ...
                    datax += '</td>';
                    datax += `<td>
                        <a href="/Chapterbook/Edit/${value.id}" class="btn btn-sm btn-info"
                        data-toggle="tooltip" title="Editar"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                        <form action="/Chapterbook/Delete/${value.id}" method="post" class="js-delete inline">
                            <button type="submit" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Eliminar">
                                <i class="fa fa-trash-o" aria-hidden="true"></i>
                            </button>
                            <input name="__RequestVerificationToken" type="hidden" value="${token}">
                        </form>
                        <form action="/Chapterbook/IsApproved/${value.id}" method="post" class="js-approved inline">
