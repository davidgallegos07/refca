        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data.items, function (key, value) {
                    ...
                    datax += '</td>';
                    datax += '<td> <a href="' + value.thesisPath + '">Descargar</a></td>';
                    datax += '<td>';
                    ...
                    datax += '</td>';
                    datax += `<td>
                        <a href="/Thesis/Edit/${value.id}" class="btn btn-sm btn-info"
                        data-toggle="tooltip" title="Editar"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                        <form action="/Thesis/Delete/${value.id}" method="post" class="js-delete inline">
                            <button type="submit" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Eliminar">
                                <i class="fa fa-trash-o" aria-hidden="true"></i>
                            </button>
                            <input name="__RequestVerificationToken" type="hidden" value="${token}">
                        </form>
                        <form action="/Thesis/IsApproved/${value.id}" method="post" class="js-approved inline">
